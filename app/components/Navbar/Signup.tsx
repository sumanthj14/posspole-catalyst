  ...
  return (
    <>
      <div className="flex items-center">
        <button 
          type="button" 
          className='justify-end text-sm sm:text-base font-semibold bg-navyblue py-2 px-3 sm:px-4 navbutton rounded-full text-white cursor-pointer min-h-[36px] min-w-[70px]'
          onClick={openModal}
